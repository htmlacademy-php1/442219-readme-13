<div class="adding-post__textarea-wrapper form__input-wrapper">
    ...
    <div class="form__input-section <?= isset($errors['post-link']) ? 'form__input-section--error' : ''; ?>">
        <input class="adding-post__input form__input" id="post-link" type="text" name="post-link" placeholder="Введите ссылку" value="<?= (!empty($new_post['post-link'])) ? $new_post['post-link'] : ''; ?>">
