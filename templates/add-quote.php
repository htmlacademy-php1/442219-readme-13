<div class="adding-post__input-wrapper form__textarea-wrapper">
    ...
    <div class="form__input-section <?= isset($errors['quote-text']) ? 'form__input-section--error' : ''; ?>">
        <textarea class="adding-post__textarea adding-post__textarea--quote form__textarea form__input" id="cite-text" name="quote-text" placeholder="Текст цитаты"><?= $new_post['quote-text']; ?></textarea>
